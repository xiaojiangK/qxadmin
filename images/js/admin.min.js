...
(function (){
    ...
    // topmenu
    $('.topmenu .toggle, .topmenu .nav-child').hover(function (){
        $('.topmenu .nav-child').fadeIn('fast').animate({
            top: '50px'
        });
        $('.topmenu .icondown').css('transform', 'rotate(180deg)');
    }, function (){
        $('.topmenu .nav-child').stop().fadeOut('fast').animate({
            top: '65px'
        });
        $('.topmenu .icondown').css('transform', 'rotate(0)');
    });
})(window);