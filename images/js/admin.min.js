            ...
            $('qx-select').each(function (index){
                ...
                $('.qx-select').eq(index).html(`
                    <div class="qx-input ${size ? size : ''}">
                        <input type="text" ${!filter ? 'readonly' : ''} name="${name ? name : ''}" value="${isIcon ? ' ' : value}" autocomplete="off" ${place ? `placeholder="${place}"` : ''} ${isIcon ? `data-value='iconfont icon-${icon}'` : ''} class="qx-input_inner" />
