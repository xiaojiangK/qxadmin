...
;(function($){
        ...
        var init = function(dom) {
            ...
            function(i, item) {
                ...
                function(j, item2) {
                    ...
                    var defaults = opts.defaultClose;
                    if (item2.width) {
                    ...
                    if (item2.checkBox) {
                        ...
                        if (collapse && pid > 0) {
                            arrB.push(`<td ${pid ? `data-pid=${pid}` : ''} class="${defaults ? 'none' : ''}" ${tdw}>
                                <div role="switch" class="${item[item2.keyName] == '1' ? 'is-checked' : ''} qx-switch">
    ...
    $.fn.collapse = function (option){
        var config = {};
        var opts = $.extend(config, option);
        $(this).off().on('click', '.panel-header', function (){
