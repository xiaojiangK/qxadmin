...
;(function($){
    ...
    $.fn.layer = function (option){
        ...
        $('body').append(`
            <div role="layer" class="qx-layer">
                ...
                <div class="qx-layer-content">
                    ${opts.iframe ? `<iframe scrolling="auto" allowtransparency="true" style="height: ${$(window).height() * 0.95 - 42}px" frameborder="0" src="${opts.content}"></iframe>` : opts.content}
                </div>
            </div>
            <div class="mask"></div>
        `);
        ...
        if (opts.iframe) {
            $(window).resize(function (){
                $('.qx-layer iframe').css("height", $(window).height() * 0.95 - 42);
            });
        }
        // move
        if (opts.move) {
    ...
    $.fn.cascader = function (option){
        ...
        var menu2 = '';
        var menu3 = '';
        for (let i of opts.options) {
            menu += `
                <li class="menuitem">
                    <span class="qx-popper_label">${i.label}</span>
            ...
            //     menu2 += `
            //         <li class="menuitem">
            //             <span class="qx-popper_label">${j.label}</span>
            //             <i class="iconfont icon-arrowright"></i>
            //         </li>
            //     `;
            ...
            //         menu3 += `
            //             <li class="menuitem">
            //                 <span class="qx-popper_label">${k.label}</span>
            //                 <i class="iconfont icon-arrowright"></i>
            //             </li>
            //         `;
            //     }
        ...
        $('.qx-cascader').each(function (){
            $(this).append(`
                <div class="qx-popper">
                    <div class="qx-popper-panel">
                        <div class="qx-popper-menu">
                            <div class="qx-popper_wrap">
                                <ul class="qx-popper_list">
                                    ${menu}
                                </ul>
                            </div>
                        </div>
        ...
        $(this).find('.qx-popper-menu').each(function (){
            $(this).find('.menuitem').each(function (idx2){
                $(this).on('click', function (){
...
(function (){
    ...
    $('qx-cascader').each(function (){
        ...
        $(this).wrapAll(`<div class="${type ? type+' ' : ''}qx-cascader"><qx-input ${place ? `placeholder=${place}` : ''}></qx-input></div>`);
    });
    ...
    $('qx-button').each(function (){
        ...
        $(this).wrapAll(`<button type="${native ? native : 'button'}" class="${icon == 'icon-loading' ? 'is-loading ' : ''}${type ? type+' ' : ''}${round ? round+' ' : ''}${size ? size+' ' : ''}${disabled ? 'is-disabled ' : ''}qx-button">
    ...
    function initTabs(that) {
        ...
        if (t.hasClass(that, 'active') && href != 'javascript:;' && href != 'javascript:void(0)') {
            $(that).tabs({
                addItem: {
                    title: `${text}`,
                    content: `<iframe frameborder="0" src="${href}" scrolling="yes"></iframe>`
                }
            });
        }
    }
