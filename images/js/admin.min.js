...
(function (){
    // breadcrumb
    $('qx-breadcrumb').each(function (){
        
    });

    $('qx-cascader').each(function (){
        $(this).wrapAll(`
            <div class="qx-cascader city">
                <ul>
                    <li><qx-select placeholder="请选择" name="prov"></qx-select></li>
                    <li><qx-select placeholder="请选择" name="city"></qx-select></li>
                    <li><qx-select placeholder="请选择" name="dist"></qx-select></li>
                </ul>
            </div>
        `);
    });
                ...
                <div class="qx-select-dropdown">
                    <div class="qx-scrollbar">
                        <div class="qx-scrollbar_wrap">
                            ...
                            <div class="qx-select_empty" ${empty ? `style="display: block"` : ''}>${empty}</div>
                        </div>
    ...
    $('.qx-top .left_open').on('click', function (){
        const navMenu = $('.qx-navmenu, #side-nav');
        const navText = $('.qx-navmenu .right');
        const subMenu = $('.qx-navmenu .sub-menu');
        const menuIcon = $(this).find('.icon-menu');
    ...
    $('.qx-navmenu #nav a').each(function (){
        ...
        $(this).on('click', function (){
            const nav = $(this).parents('#nav');
            const aLi = $(this).parents('li').siblings();
            const subMenu = $(this).siblings('.sub-menu');
            const arrow = $(this).find('.icon-arrowright');
