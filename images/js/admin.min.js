...
;(function($){
    ...
    $.fn.DatePicker = function (option){
        ...
        var val = [];
        var opts = $.extend(config, option);
        var input = $(this).find('.c-datepicker-date-editor');
        $(input).datePicker({
            min: opts.min,
            max: opts.max,
            format: opts.format,
    ...
    $.fn.tabs = function (option){
        ...
        var opts = $.extend(config, option);
        $(document).off().on('click', '.qx-tabs_item', function (){
...
(function (){
    ...
    $('qx-form').each(function (index){
        $(this).wrapAll(`<form class="qx-form"></form>`);
        ...
        $(this).find('qx-form-item').each(function (){
            ...
            formItem+=`
                <div class="${required ? 'required ' : ''}qx-form-item">
                    ...
                    <div class="qx-form_con" ${width ? `style="margin-left: ${width}"` : ''}>
                        ${$(this).html()}
                    </div>
                </div>
            `;
        ...
        if ($('.qx-input').length > 0 || $('.qx-textarea').length > 0) {
           $('body').input();
        }
    });
})(window);
