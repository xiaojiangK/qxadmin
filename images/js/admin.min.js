...
class Base {
    ...
    ajax(opt) {
        var options = {
            ...
            refresh: false,                                     // 提交成功后是否刷新
            dataType: '',                                       // 预期的服务器响应的数据类型。
            error: function() {},                               // 如果请求失败要运行的函数。
            success: function() {},                             // 当请求成功时运行的函数。
    ...
    comfirm(opt) {
        var options = {
            msg: '',                // 确认框提示语
            type: 'warning',        // 提示框类型，默认警告
            refresh: false,         // 确认后是否刷新，默认false
...
;(function($){
    ...
    $.fn.validate = function (option){
        ...
        $(this).find('.qx-form-item').each(function (){
            ...
            var label = $(this).find('.qx-form_label');
