    ...
    $.fn.table = function(options) {
        ...
        var init = function(dom) {
            ...
            function(i, item) {
                ...
                function(i, item2) {
                    if (item2.checkBox) {
                        arrB.push("<td><span class='checkboxs'><input type='checkbox' class='testclass' name='Checks' value='" + item[item2.keyName] + "'/></span></td>");
                    } else {
                        arrB.push("<td>" + item[item2.keyName] + "</td>");
                    }
                });
                arrB.push("</tr>");
            });
        ...
        var setOverflowHeight = function(id) {
            ...
            $("#" + id + "-qxable-data").parents('table').css({
                "border": opts.border ? '1px solid #ebeef5' : ''
            })
        }
