            ...
            function(i, item) {
                ...
                function(j, item2) {
                    ...
                    if (item2.checkBox) {
                        ...
                        arrB.push(`<td ${tdw}>
                            <div role="switch" class="${item[item2.keyName] ? 'is-checked' : ''} qx-switch">
                                <input type="checkbox" name="" ${item[item2.keyName] ? 'checked' : ''} class="qx-form_input">
