...
(function($) {
    $.fn.citySelect = function(settings) {
        ...
        settings);
        var box_obj = this;
        var prov_obj = box_obj.find(".qx-select_list").eq(0);
        var city_obj = box_obj.find(".qx-select_list").eq(1);
        var dist_obj = box_obj.find(".qx-select_list").eq(2);
        var prov_val = settings.prov;
        var city_val = settings.city;
        var dist_val = settings.dist;
        var select_prehtml = (settings.required) ? "": '<li class="qx-select_item" data-idx="">请选择<span class="iconfont icon-hook"></span></li>';
        var city_json;
        var cityStart = function() {
            var prov_id = $(prov_obj).find('.qx-select_item').eq(0).attr('data-idx');
            ...
            function(i, city) {
            temp_html += `<li class="qx-select_item" data-idx="${i}">${city.n}<span class="iconfont icon-hook"></span></li>`
        ...
        var distStart = function() {
            var prov_id = $(prov_obj).find('.qx-select_item').eq(0).attr('data-idx');
            var city_id = $(city_obj).find('.qx-select_item').eq(0).attr('data-idx');
            if (!settings.required) {
                prov_id--;
                city_id--;
            };
            ...
            function(i, dist) {
                temp_html += `<li class="qx-select_item" data-idx="${i}">${dist.n}<span class="iconfont icon-hook"></span></li>`
        ...
        var init = function() {
            ...
            function(i, prov) {
            temp_html += `<li class="qx-select_item" data-idx="${i}">${prov.p}<span class="iconfont icon-hook"></span></li>`;
